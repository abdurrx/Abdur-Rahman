...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen relative overflow-hidden bg-black">
      <ParticleCanvas />
      <div className="max-w-screen-lg md:max-w-7xl mx-auto px-10 md:px-6 pt-24">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-16">
          ...
          className="relative group lg:w-1/2">
            ...
            className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-primary via-secondary to-tertiary bg-clip-text text-transparent mb-4 md:mb-6">
              Full Stack
              <br/>
            ...
            className="text-xl text-content/80 text-justify mb-6 md:mb-8">
          ...
          className="md:w-1/2 relative">
            ...
            <div className="realtive w-80 md:w-[600px] aspect-square group">
              {/* Floating Animation */}
              <motion.div
              className="relative aspect-square rounded-3xl overflow-hidden bg-surface backdrop-blur-sm">
                ...
                className="absolute bottom-8 left-8">
                  <div className="text-2xl md:text-3xl font-bold text-content">
                    <motion.span
