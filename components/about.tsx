...
export default function About() {
  return (
    <section id="about" className="min-h-screen py-48 md:py-52 relative">
      <div className="max-w-screen-lg md:max-w-6xl mx-auto px-6">
        ...
        className="flex flex-col items-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-content mb-4 text-center">About Me</h2>
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="text-2xl text-content/80 text-justify">
